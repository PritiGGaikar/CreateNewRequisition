...
public class RW
{
 ...
 public static String path="C:\\Users\\Priti\\workspace\\PerformanceTest_Purchase\\"; 
 ...
 protected int k=500;
     ...
     public ExcelRead input_purc_m = new ExcelRead(path.concat("Excel\\input_purc_m.xlsx")); 
     
     public WriteExcel write_data = new WriteExcel(path.concat("Excel\\input_purc_m.xlsx"));
